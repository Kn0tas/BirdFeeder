...
// Linker symbols for the embedded TFLite file (added via EMBED_FILES in
// CMakeLists.txt)
extern const unsigned char
    _binary_model_int8_tflite_start[] asm("_binary_model_int8_tflite_start");
extern const unsigned char
    _binary_model_int8_tflite_end[] asm("_binary_model_int8_tflite_end");
